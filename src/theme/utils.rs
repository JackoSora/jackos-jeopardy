...
pub fn alpha_blend(foreground: egui::Color32, background: egui::Color32) -> egui::Color32 {
    ...
    let r = ((foreground.r() as f32 * fg_alpha
        + background.r() as f32 * bg_alpha * (1.0 - fg_alpha))
        / out_alpha) as u8;
    let g = ((foreground.g() as f32 * fg_alpha
        + background.g() as f32 * bg_alpha * (1.0 - fg_alpha))
        / out_alpha) as u8;
    let b = ((foreground.b() as f32 * fg_alpha
        + background.b() as f32 * bg_alpha * (1.0 - fg_alpha))
        / out_alpha) as u8;
